...
print_array( xduce( map( "_,y => 2*y" ), appending( 1 ), {},
                    ipairs( t ) ) )
...
print_array( xduce( filter( "_,y => y%2==1" ), appending( 2 ), {},
                    ipairs( t ) ) )
...
resume_x( function( ... )
  print( ... )
  print_array( xduce( yio, appending( 2 ), {},
                      yielding_iterator( 3 ) ) )
  return "return"
end )
__________()
...
print_array( xduce( take( "_,y => y<4" ), appending( 2 ), {},
                    ipairs( numbers ) ) )
...
resume_x( function( ... )
  print( ... )
  print_array( xduce( takelty, appending( 2 ), {},
                      yielding_iterator( 5 ) ) )
  return "return"
end )
__________()
...
print_array( xduce( drop( "_,y => y<4" ), appending( 2 ), {},
                    ipairs( numbers ) ) )
...
print( "sum", reduce( "s,x => s+x", 0, { 1, 2, 3 } ) )
